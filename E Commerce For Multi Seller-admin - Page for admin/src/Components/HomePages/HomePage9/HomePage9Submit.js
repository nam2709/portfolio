...
const HomePage9Submit = values => {
  ...
  if (values['homeBanner9Image']) {
    values['content']['home_banner']['main_banner']['image_url'] =
      values['homeBanner9Image'].original_url
  ...
  if (values['sliderProduct1']) {
    values['content']['slider_product_with_banner']['slider_products']['product_slider_1'][
      'product_ids'
    ] = values['sliderProduct1']
  }
  if (values['sliderProduct2']) {
    values['content']['slider_product_with_banner']['slider_products']['product_slider_2'][
      'product_ids'
    ] = values['sliderProduct2']
  }
  if (values['sliderProduct3']) {
    values['content']['slider_product_with_banner']['slider_products']['product_slider_3'][
      'product_ids'
  ...
  if (values['leftSliderBannerLinkType']) {
    values['content']['slider_product_with_banner']['left_side_banners']['banner_1'][
      'redirect_link'
    ]['link_type'] = values['leftSliderBannerLinkType']
  } else {
    values['content']['slider_product_with_banner']['left_side_banners']['banner_1'][
      'redirect_link'
    ]['link_type'] = ''
  ...
  if (values['leftSliderBannerLink']) {
    values['content']['slider_product_with_banner']['left_side_banners']['banner_1'][
      'redirect_link'
    ]['link'] = values['leftSliderBannerLink']
    if (values['leftSliderBannerLinkType'] == 'product') {
      values['content']['slider_product_with_banner']['left_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = values['leftSliderBannerLink']
    } else {
      values['content']['slider_product_with_banner']['left_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = ''
