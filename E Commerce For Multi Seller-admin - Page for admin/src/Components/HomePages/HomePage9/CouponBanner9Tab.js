  ...
  return (
    <>
      <FileUploadField
        ...
        title="Image"
        id="couponBannerImage"
        showImage={values['couponBannerImage']}
        type="file"
        values={values}
        setFieldValue={setFieldValue}
        helpertext={getHelperText('1522x136px')}
      />
      <CommonRedirect
        values={values}
        setFieldValue={setFieldValue}
        ...
        nameList={{ selectNameKey: 'couponBannerLinkType', multipleNameKey: 'couponBannerLink' }}
      />
