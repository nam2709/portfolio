const HomePage4InitialValue = data => {
  ...
  data?.content?.value_banners?.banners.length > 0 &&
    data?.content?.value_banners?.banners.forEach((elem, index) => {
      ...
      elem?.redirect_link
        ? (obj[`valueBannerLinkType${index}`] = elem?.redirect_link?.link_type)
        : ''
  ...
  return {
    ...
    // Images
    homeBannerBackgroungImage: data?.content?.home_banner?.bg_image_url
      ? { original_url: data?.content?.home_banner?.bg_image_url }
      : '',
    ...
    homeBannerSub1Image: data?.content?.home_banner?.sub_banner_1?.image_url
      ? { original_url: data?.content?.home_banner?.sub_banner_1?.image_url }
      : '',

    homeBannerSub2Image: data?.content?.home_banner?.sub_banner_2?.image_url
      ? { original_url: data?.content?.home_banner?.sub_banner_2?.image_url }
      : '',

    homeBannerSub3Image: data?.content?.home_banner?.sub_banner_3?.image_url
      ? { original_url: data?.content?.home_banner?.sub_banner_3?.image_url }
      : '',

    categoryProductImage: data?.content?.categories_image_list?.image_url
      ? { original_url: data?.content?.categories_image_list?.image_url }
      : '',

    twoColumnBanner1Image: data?.content?.two_column_banners?.banner_1?.image_url
      ? { original_url: data?.content?.two_column_banners?.banner_1?.image_url }
      : '',

    twoColumnBanner2Image: data?.content?.two_column_banners?.banner_2?.image_url
      ? { original_url: data?.content?.two_column_banners?.banner_2?.image_url }
      : '',
    ...
    newsLetterBgImage: data?.content?.news_letter?.bg_url
      ? { original_url: data?.content?.news_letter?.bg_url }
      : '',
    ...
    homeSubBanner3LinkType:
      data?.content?.home_banner?.sub_banner_3?.redirect_link?.link_type || '',
