...
const OrderTabs = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  return (
    <>
      ...
      <TabPane tabId="8">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product2ProductIds'}
          nameKey={'products_list_2'}
          productData={productData}
          setSearch={setSearch}
        />
      </TabPane>
      <TabPane tabId="9">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product3ProductIds'}
          nameKey={'products_list_3'}
          setSearch={setSearch}
          productData={productData}
        />
      </TabPane>
      ...
      <TabPane tabId="11">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product4ProductIds'}
          nameKey={'products_list_4'}
          productData={productData}
          setSearch={setSearch}
        />
      </TabPane>
      <TabPane tabId="12">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product5ProductIds'}
          nameKey={'products_list_5'}
          productData={productData}
          setSearch={setSearch}
        />
      </TabPane>
      ...
      <TabPane tabId="14">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product6ProductIds'}
          nameKey={'products_list_6'}
          productData={productData}
          setSearch={setSearch}
        />
      </TabPane>
      <TabPane tabId="15">
        <ProductListCategory6Tab
          values={values}
          setFieldValue={setFieldValue}
          productName={'product7ProductIds'}
          nameKey={'products_list_7'}
          productData={productData}
          setSearch={setSearch}
        />
      </TabPane>
