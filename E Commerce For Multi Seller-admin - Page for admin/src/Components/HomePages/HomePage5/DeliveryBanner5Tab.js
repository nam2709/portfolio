    ...
    <>
      ...
      <div className="inside-horizontal-tabs">
        ...
        <TabContent activeTab={activeTab}>
          <TabPane tabId="1">
            <CommonDeliveryBanner
              values={values}
              setFieldValue={setFieldValue}
              bannerName={'banner_1'}
              imageName={'twoColumnBanner1Image'}
              list={true}
              selectNameKey={'delivery1LinkType'}
              multipleNameKey={'delivery1Link'}
          ...
          <TabPane tabId="2">
            <CommonDeliveryBanner
              ...
              setFieldValue={setFieldValue}
              bannerName={'banner_2'}
              imageName={'twoColumnBanner2Image'}
              selectNameKey={'delivery2LinkType'}
              multipleNameKey={'delivery2Link'}
              categoryData={categoryData}
              productData={productData}
              setSearch={setSearch}
            />
