      ...
      select: res =>
        res?.data?.data.map(elem => {
          return {
            id: elem.id,
            name: elem.name,
            image: elem?.category_icon?.original_url || placeHolderImage,
            slug: elem?.slug,
          }
        }),
    }
  ...
  return (
    <Col xl="7" lg="8">
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId="7">
          <ProductBundleTab values={values} setFieldValue={setFieldValue} />
        </TabPane>
        <TabPane tabId="8">
          <SliderProductTab
            values={values}
        ...
        <TabPane tabId="9">
          <FeatureBlogTab values={values} setFieldValue={setFieldValue} />
        </TabPane>
        <TabPane tabId="10">
