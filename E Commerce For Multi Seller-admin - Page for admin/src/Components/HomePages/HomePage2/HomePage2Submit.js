...
const HomePage2Submit = values => {
  ...
  if (values['homeMainBannerImage']) {
    values['content']['home_banner']['main_banner']['image_url'] =
      values['homeMainBannerImage'].original_url
  ...
  if (values['homeMainSubBanner1Image']) {
    values['content']['home_banner']['sub_banner_1']['image_url'] =
      values['homeMainSubBanner1Image'].original_url
  ...
  if (values['homeMainSubBanner2Image']) {
    values['content']['home_banner']['sub_banner_2']['image_url'] =
      values['homeMainSubBanner2Image'].original_url
  } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

  if (values['categoriesIconImage']) {
    values['content']['categories_icon_list']['image_url'] =
      values['categoriesIconImage'].original_url
  ...
  if (values['mainContentRightBanner1Image']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] =
      values['mainContentRightBanner1Image'].original_url
  } else
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['image_url'] = ''

  if (values['mainContentRightBanner2Image']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['image_url'] =
      values['mainContentRightBanner2Image'].original_url
  } else
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['image_url'] = ''
  ...
  if (values['mainContentSection3ProductIds']) {
    values['content']['main_content']['section3_products']['product_ids'] =
      values['mainContentSection3ProductIds']
  }
  ...
  if (values['mainContentSection4ProductIds']) {
    values['content']['main_content']['section4_products']['product_ids'] =
      values['mainContentSection4ProductIds']
  }

  if (values['mainLeftProduct1']) {
    values['content']['main_content']['section1_products']['product_ids'] =
      values['mainLeftProduct1']
  }
  if (values['mainLeftProduct2']) {
    values['content']['main_content']['section2_slider_products']['product_ids'] =
      values['mainLeftProduct2']
  }
  ...
  if (values['mainRightBanner1LinkType']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1'][
      'redirect_link'
    ] = {}
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = values['mainRightBanner1LinkType']
  } else {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = ''
  ...
  if (values['mainRightBanner1Link']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_1']['redirect_link'][
      'link'
    ] = values['mainRightBanner1Link']
    if (values['mainRightBanner1LinkType'] == 'product') {
      values['content']['main_content']['sidebar']['right_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = values['mainRightBanner1Link']
    } else {
      values['content']['main_content']['sidebar']['right_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = ''
  ...
  if (values['mainRightBanner2LinkType']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2'][
      'redirect_link'
    ] = {}
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = values['mainRightBanner2LinkType']
  } else {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = ''
  ...
  if (values['mainRightBanner2Link']) {
    values['content']['main_content']['sidebar']['right_side_banners']['banner_2']['redirect_link'][
      'link'
    ] = values['mainRightBanner2Link']
    if (values['mainRightBanner2LinkType'] == 'product') {
      values['content']['main_content']['sidebar']['right_side_banners']['banner_2'][
        'redirect_link'
      ]['product_ids'] = values['mainRightBanner2Link']
    } else {
      values['content']['main_content']['sidebar']['right_side_banners']['banner_2'][
        'redirect_link'
      ]['product_ids'] = ''
