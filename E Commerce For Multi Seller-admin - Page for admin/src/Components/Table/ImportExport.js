...
const ImportExport = ({ importExport }) => {
  ...
  return (
    <>
      {/* <a className="btn-outline btn btn-secondary" onClick={() => setModal(true)}>
        <RiUpload2Line />
        {t('Import')}
      </a>
      <a className="btn-outline btn btn-secondary" onClick={() => exportUser()}>
        <RiDownload2Line />
        {t('Export')}
      </a> */}
                    ...
                    <Form className="theme-form theme-form-2 mega-form">
                      ...
                      <div className="modal-footer">
                        {values?.users.length > 0 && (
                          <a href="#javascript" onClick={() => setFieldValue('users', '')}>
                            {t('Clear')}
                          </a>
                        )}
