          ...
          <>
                ...
                !optionPermission?.noEdit && (
                  <>
                    {optionPermission?.editRedirect ? (
                      <Link
                        href={
                          `/${i18Lang}/` + optionPermission?.editRedirect + '/update/' + fullObj.id
                        }
                      >
                        <RiPencilLine />
                      </Link>
                      ...
                      <Link
                        href={`/${i18Lang}/${pathname.split('/')[2]}/category/update/${fullObj.id}`}
                      >
                        <RiPencilLine />
                      </Link>
                    ) : (
            ...
            <div>
              {destroy && !optionPermission?.noDelete && (
                <DeleteButton obj={fullObj} mutate={mutate} refetch={refetch}/>
              )}
            </div>
          </>
        )}
