  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle
        ...
        titleList={SettingPaymentMethodTab}
        errors={errors}
        touched={touched}
      />
      <TabContent activeTab={activeTab}>
        <TabPane tabId="1">
          {' '}
          <>
            {Object.keys(PaypalProvider).map(key => (
              <div key={key}>
        ...
        <TabPane tabId="2">
          {' '}
          {Object.keys(StripeProvider).map(key => (
            <div key={key}>
        ...
        <TabPane tabId="3">
          {Object.keys(RazorpayProvider).map(key => (
            <div key={key}>
        ...
        <TabPane tabId="4">
          {' '}
          {Object.keys(CashOnDeliveryProvider).map(key => (
            <div key={key}>
        ...
        <TabPane tabId="5">
          {Object.keys(MollieProvider).map(key => (
            <div key={key}>
