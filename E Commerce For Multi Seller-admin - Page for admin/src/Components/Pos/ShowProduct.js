        ...
        <div className="product-detail">
          ...
          <div className="counter-box">
            <h6 className="sold theme-color">
              {productData['type'] == 'classified'
                ? convertCurrency(productData.variations?.[0]?.price)
                : convertCurrency(productData?.sale_price)}
            </h6>
            <div className="addtocart_btn">
              <Btn
                className={`add-button addcart-button buy-button ${!productData.variations.length && productData.stock_status !== 'in_stock' ? 'disabled' : ''}`}
