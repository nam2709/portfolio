...
const TopSellingProduct = ({ setFieldValue, values }) => {
    ...
    const { data, refetch, isLoading } = useQuery([product], () => request({ url: product, params: { status: 1, top_selling: 1, paginate: 5 } }), { enabled: false, refetchOnWindowFocus: false, select: (data) => data.data.data });
