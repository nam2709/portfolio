...
const TableWarper = WrappedComponent => {
  const HocComponent = forwardRef(
    (
      ...
      const currentPage = userIdParams
        ? data?.data?.transactions?.current_page
        : page
      const total = userIdParams
        ? data?.data?.transactions?.total
        : data?.data?.total
      const perPage = userIdParams
            ...
            <CardBody className="custom-role">
              ...
              <div className="table-responsive border-table">
                <WrappedComponent
                  ...
                  type={type}
                  current_page={
                    userIdParams ? data?.data?.transactions?.current_page : page
                  }
                  per_page={
                    userIdParams ? data?.data?.transactions?.per_page : paginate
                  }
                  url={url}
