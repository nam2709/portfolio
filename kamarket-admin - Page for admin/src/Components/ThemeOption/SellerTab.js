      ...
      <div className="selection-layout mb-4 radio-type-sec">
        ...
        <Row xxl={4} xl={3} lg={2} md={3} xs={2} className="g-4 w-100">
          {SellerAboutStore.map((elem, i) => (
            <div
              key={i}
              onClick={() => setFieldValue('[options][seller][store_layout]', elem?.value)}
            >
              <div className="selection-box text-center">
                <Input
                  ...
                  id={elem?.value}
                  defaultChecked={
                    values['options']?.['seller']?.['store_layout'] == elem.value ? true : false
                  }
                />
      ...
      <div className="selection-layout mb-4 radio-type-sec">
        ...
        <Row xxl={4} xl={3} lg={2} md={3} xs={2} className="g-4 w-100">
          {SellerSetailsStore.map((elem, i) => (
            <div
              key={i}
              onClick={() => setFieldValue('[options][seller][store_details]', elem?.value)}
            >
              <div className="selection-box text-center">
                <Input
                  name={'store_details'}
                  ...
                  id={elem.value}
                  defaultChecked={
                    values['options']?.['seller']?.['store_details'] == elem.value ? true : false
                  }
                />
                <Label htmlFor={elem.value}>
                  <div>
