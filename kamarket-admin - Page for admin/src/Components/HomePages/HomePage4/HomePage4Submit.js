...
const HomePage4Submit = values => {
  ...
  if (values['homeBannerBackgroungImage']) {
    values['content']['home_banner']['bg_image_url'] =
      values['homeBannerBackgroungImage'].original_url
  ...
  if (values['homeBannerSub1Image']) {
    values['content']['home_banner']['sub_banner_1']['image_url'] =
      values['homeBannerSub1Image'].original_url
  ...
  if (values['homeBannerSub2Image']) {
    values['content']['home_banner']['sub_banner_2']['image_url'] =
      values['homeBannerSub2Image'].original_url
  } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

  if (values['homeBannerSub3Image']) {
    values['content']['home_banner']['sub_banner_3']['image_url'] =
      values['homeBannerSub3Image'].original_url
  } else values['content']['home_banner']['sub_banner_3']['image_url'] = ''

  if (values['categoryProductImage']) {
    values['content']['categories_image_list']['image_url'] =
  ...
  if (values['twoColumnBanner1Image']) {
    values['content']['two_column_banners']['banner_1']['image_url'] =
      values['twoColumnBanner1Image'].original_url
  } else values['content']['two_column_banners']['banner_1']['image_url'] = ''

  if (values['twoColumnBanner2Image']) {
    values['content']['two_column_banners']['banner_2']['image_url'] =
      values['twoColumnBanner2Image'].original_url
  ...
  values['content']['value_banners']['banners'].forEach((elem, i) => {
    if (values[`featureBannerImage${i}`]) {
      values['content']['value_banners']['banners'][i]['image_url'] =
