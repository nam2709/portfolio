...
const HomePage1Submit = values => {
  ...
  if (values['product_ids']) {
    values['content']['main_content']['sidebar']['sidebar_products']['product_ids'] =
      values['product_ids']
  }
  if (values['mainRightBannerProductIds']) {
    values['content']['main_content']['section4_products']['product_ids'] =
      values['mainRightBannerProductIds']
  }
  if (values['mainRight1TabProductIds']) {
    values['content']['main_content']['section1_products']['product_ids'] =
      values['mainRight1TabProductIds']
  }
  if (values['mainRight7TabProductIds']) {
    values['content']['main_content']['section7_products']['product_ids'] =
      values['mainRight7TabProductIds']
  }
  if (values['mainRightContentBlog']) {
    values['content']['main_content']['section9_featured_blogs']['blog_ids'] =
      values['mainRightContentBlog']
  }
  if (values['mainLeftCategory']) {
    values['content']['main_content']['sidebar']['categories_icon_list']['category_ids'] =
      values['mainLeftCategory']
  }

  // For Passing images
  if (values['homeBannerMainImage']) {
    values['content']['home_banner']['main_banner']['image_url'] =
      values['homeBannerMainImage'].original_url
  } else values['content']['home_banner']['main_banner']['image_url'] = ''

  if (values['homeBannerSubBanner1Image']) {
    values['content']['home_banner']['sub_banner_1']['image_url'] =
      values['homeBannerSubBanner1Image'].original_url
  } else values['content']['home_banner']['sub_banner_1']['image_url'] = ''

  if (values['homeBannerSubBanner2Image']) {
    values['content']['home_banner']['sub_banner_2']['image_url'] =
      values['homeBannerSubBanner2Image'].original_url
  } else values['content']['home_banner']['sub_banner_2']['image_url'] = ''

  if (values['mainLeftBanner1']) {
    values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] =
      values['mainLeftBanner1'].original_url
  } else
    values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['image_url'] = ''

  if (values['mainLeftBanner2']) {
    values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] =
      values['mainLeftBanner2'].original_url
  } else
    values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['image_url'] = ''

  if (values['section2CategoryImage']) {
    values['content']['main_content']['section2_categories_list']['image_url'] =
      values['section2CategoryImage'].original_url
  } else values['content']['main_content']['section2_categories_list']['image_url'] = ''

  if (values['section3Banner1']) {
    values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] =
      values['section3Banner1'].original_url
  } else
    values['content']['main_content']['section3_two_column_banners']['banner_1']['image_url'] = ''

  if (values['section3Banner2']) {
    values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] =
      values['section3Banner2'].original_url
  } else
    values['content']['main_content']['section3_two_column_banners']['banner_2']['image_url'] = ''

  if (values['section5CouponsImage']) {
    values['content']['main_content']['section5_coupons']['image_url'] =
      values['section5CouponsImage'].original_url
  } else values['content']['main_content']['section5_coupons']['image_url'] = ''

  if (values['section6_twocolumnBanner1']) {
    values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] =
      values['section6_twocolumnBanner1'].original_url
  } else
    values['content']['main_content']['section6_two_column_banners']['banner_1']['image_url'] = ''

  if (values['section6_twocolumnBanner2']) {
    values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] =
      values['section6_twocolumnBanner2'].original_url
  } else
    values['content']['main_content']['section6_two_column_banners']['banner_2']['image_url'] = ''

  if (values['section8_VegitableImage']) {
    values['content']['main_content']['section8_full_width_banner']['image_url'] =
      values['section8_VegitableImage'].original_url
  } else values['content']['main_content']['section8_full_width_banner']['image_url'] = ''

  if (values['mainContentSidebarCategoryImage']) {
    values['content']['main_content']['sidebar']['categories_icon_list']['image_url'] =
      values['mainContentSidebarCategoryImage'].original_url
  ...
  values['content']['featured_banners']['banners'].forEach((elem, i) => {
    if (values[`featureBannerImage${i}`]) {
      values['content']['featured_banners']['banners'][i]['image_url'] =
        values[`featureBannerImage${i}`].original_url
    } else {
      values['content']['featured_banners']['banners'][i]['image_url'] = ''
    }
    if (values[`featureRedirectLinkType${i}`] || values[`featureRedirectLink${i}`]) {
      values['content']['featured_banners']['banners'][i]['redirect_link']['link_type'] =
        values[`featureRedirectLinkType${i}`]
      values['content']['featured_banners']['banners'][i]['redirect_link']['link'] =
        values[`featureRedirectLink${i}`]
  ...
  if (values['mainLeftBanner1LinkType']) {
    ...
    values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = values['mainLeftBanner1LinkType']
  } else {
    values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = ''
  ...
  if (values['mainLeftBanner1Link']) {
    values['content']['main_content']['sidebar']['left_side_banners']['banner_1']['redirect_link'][
      'link'
    ] = values['mainLeftBanner1Link']
    if (values['mainLeftBanner1LinkType'] == 'product') {
      values['content']['main_content']['sidebar']['left_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = values['mainLeftBanner1Link']
    } else {
      values['content']['main_content']['sidebar']['left_side_banners']['banner_1'][
        'redirect_link'
      ]['product_ids'] = ''
  ...
  if (values['mainLeftBanner2LinkType']) {
    ...
    values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = values['mainLeftBanner2LinkType']
  } else {
    values['content']['main_content']['sidebar']['left_side_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = ''
  ...
  if (values['mainRight6LinkType1']) {
    values['content']['main_content']['section6_two_column_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = values['mainRight6LinkType1']
  } else {
    values['content']['main_content']['section6_two_column_banners']['banner_1']['redirect_link'][
      'link_type'
    ] = ''
  ...
  if (values['mainRight6LinkType2']) {
    values['content']['main_content']['section6_two_column_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = values['mainRight6LinkType2']
  } else {
    values['content']['main_content']['section6_two_column_banners']['banner_2']['redirect_link'][
      'link_type'
    ] = ''
