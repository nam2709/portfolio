  ...
  return (
    <div className="shipping-accordion-custom">
      <div
        ...
        onClick={() => setActive(7)}
      >
        {values['content']?.['main_content']['section7_products']['title']}
        <RiArrowDownLine />
      </div>
      {active == 7 && (
        <div className="rule-edit-form">
          <SimpleInputField
            nameList={[
              {
                name: `[content][main_content][section7_products][title]`,
                placeholder: t('EnterTitle'),
                title: 'Title',
              },
              {
                name: `[content][main_content][section7_products][description]`,
          ...
          />
          <CheckBoxField
            name={`[content][main_content][section7_products][status]`}
            title="Status"
          />
        </div>
      )}
