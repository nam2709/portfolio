  ...
  return (
    <div className="shipping-accordion-custom">
      <div
        ...
        onClick={() => setActive(9)}
      >
        {values['content']?.['main_content']['section9_featured_blogs']['title']}
        <RiArrowDownLine />
      </div>
      {active == 9 && (
        <div className="rule-edit-form">
          <SimpleInputField
            nameList={[
              {
                name: `[content][main_content][section9_featured_blogs][title]`,
                placeholder: t('EnterTitle'),
                title: 'Title',
              },
              {
                name: `[content][main_content][section9_featured_blogs][sub_title]`,
          ...
          <MultiSelectField
            ...
            name="mainRightContentBlog"
            title="Blogs"
            data={data}
          />
          <CheckBoxField
            name="[content][main_content][section9_featured_blogs][status]"
            title="Status"
          />
        </div>
      )}
