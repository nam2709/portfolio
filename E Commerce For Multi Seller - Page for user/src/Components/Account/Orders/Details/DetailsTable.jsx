                ...
                {data?.products?.length > 0
                  ? data?.products?.map((product, i) => (
                      <tr key={i}>
                        ...
                        <td>
                          <h6><span className='span-text-price'>{formatCurrency(product?.pivot?.single_price)}</span></h6>
                        </td>
                        <td>
                          <h6>{product?.pivot?.quantity}</h6>
                        </td>
                        <td>
                          <h6><span className='span-text-price'>{formatCurrency(product?.pivot?.subtotal)}</span></h6>
                        </td>
                        <td>
                          {product?.is_return === 1 && product?.pivot?.is_refunded === 0 ? (
