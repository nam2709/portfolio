                ...
                [...fileDetail]?.map((elem, i) => (
                    <div key={i}>
                        <div className="img-box">
                             <Image src={elem instanceof File ? URL.createObjectURL(elem) : elem} className="img-fluid" width={100} height={100} alt="" />
    ...
    return (
        <>
            <a href="#javascript" className="font-blue browse-file">
                {t("browsefiles")}
                <Input type="file" {...props} onChange={(event) => onSelect(event)} />
            </a>
